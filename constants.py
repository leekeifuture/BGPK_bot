...
shedule = {
  'М56': {
      'UP': [
          ...
          [('', lesson_time['1'], 'Физкультура и здоровье', teacher_name[31] + '/' + teacher_name[93], 'с/з',),
           ('', lesson_time['2'], 'Математика ', teacher_name[45], '119',),
          ...
          [('', lesson_time['1'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Математика ', teacher_name[45], '309',),
    ...
    'DOWN': [
          ...
          [('', lesson_time['1'], 'Физкультура и здоровье', teacher_name[31] + '/' + teacher_name[93], 'с/з',),
           ('', lesson_time['2'], 'Математика ', teacher_name[45], '119',),
           ('', lesson_time['3'], 'Химия', teacher_name[44], '212',)],
          [('', lesson_time['1'], 'География', teacher_name[52], '309',),
           ('', lesson_time['2'], 'Русский язык', teacher_name[2], '120',),
           ('', lesson_time['3'], 'Химия  ', teacher_name[44], '212',)],
          [('', lesson_time['1'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Математика ', teacher_name[45], '309',),
           ('', lesson_time['3s'], 'Всемирная история ', teacher_name[28], '207')]
        ]
    },
  'М57': {
      'UP': [
          [('', lesson_time['1'], 'Иностранный язык', teacher_name[21] + '/' + teacher_name[80], '318',),
           ('', lesson_time['2'], 'Обществоведение', teacher_name[28], '207',),
           ('', lesson_time['3'], 'Математика ', teacher_name[45], '120',)],
          [('', lesson_time['1'], 'География', teacher_name[52], '312',),
          ...
          [('', lesson_time['1'], 'Математика ', teacher_name[45], '119',),
           ('', lesson_time['2'], 'Всемирная история ', teacher_name[28], '121',),
           ('', lesson_time['3'], 'Русский язык', teacher_name[56], '307',)],
          [('', lesson_time['1'], 'Физика', teacher_name[16], '202',),
           ('', lesson_time['2'], 'Биология', teacher_name[38], '310',),
           ('', lesson_time['3'], 'Химия ', teacher_name[44], '212',)],
          [('', lesson_time['1'], 'Математика ', teacher_name[45], '319',),
           ('', lesson_time['2'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['3s'], 'Всемирная история ', teacher_name[28], '207')]
        ],
    'DOWN': [
          ...
          [('', lesson_time['1'], 'Математика ', teacher_name[45], '119',),
           ('', lesson_time['2'], 'Всемирная история ', teacher_name[28], '121',),
           ('', lesson_time['3'], 'Русский язык', teacher_name[56], '307',)],
          [('', lesson_time['1'], 'Астрономия', teacher_name[76], '305',),
           ('', lesson_time['2'], 'Биология', teacher_name[38], '310',),
  ...
  'М53': {
      'UP': [
          [('', lesson_time['1'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['2'], 'Материалов.и техн.материал', teacher_name[82], '310',),
          ...
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ...
           ('', lesson_time['3'], 'Защита нас.и террит. от ЧС', teacher_name[40], '121',)],
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['2'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',),
           ('', lesson_time['3'], 'Материалов.и техн.материал', teacher_name[82], '310',)],
          [('', lesson_time['1'], 'Русская литература', teacher_name[2], '307',),
          ...
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',),
           ('', lesson_time['2'], 'Нормир.точн. и тех.измерен/Техн.мех.', teacher_name[26] + '/' + teacher_name[29], '309/114',),
           ('', lesson_time['3'], 'САПР', teacher_name[25] + '/' + teacher_name[20], '114/311',)],
          [('', lesson_time['2'], 'Белорусская литература', teacher_name[55], '305',),
           ('', lesson_time['3s'], 'Техническая механика', teacher_name[25], '111')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['2'], 'Иностранный язык', teacher_name[53] + '/' + teacher_name[21], '319/200',),
           ('', lesson_time['3'], 'Нормир.точн. и тех.измерен', teacher_name[26], '309',)],
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['2'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',),
  ...
  'М54': {
      'UP': [
          ...
          [('', lesson_time['1'], 'ОСГН', teacher_name[75], '119',),
           ('', lesson_time['2'], 'Материал.и техн.материал', teacher_name[82], '319',),
           ('', lesson_time['3s'], 'Белорусская литература', teacher_name[55], '305')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',),
           ('', lesson_time['2'], 'Защита нас.и террит. от ЧС', teacher_name[40] + '/' + teacher_name[21], '310',),
           ('', lesson_time['3'], 'Материалов.и техн.материал', teacher_name[82], '310',)],
          [('', lesson_time['2'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['3'], 'Иностранный язык', teacher_name[53] + '/' + teacher_name[21], '315/318',)],
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',),
          ...
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ...
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[59], 'с/з',)],
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['2'], 'ОСГН', teacher_name[75], '121',),
           ('', lesson_time['3'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[35], '319/200',)],
          [('', lesson_time['1'], 'ОСГН', teacher_name[75], '119',),
           ('', lesson_time['2'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['3s'], 'Белорусская литература', teacher_name[55], '305')]
  ...
  'Мс55': {
      'UP': [
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ...
           ('', lesson_time['3'], 'Информационные технологии', teacher_name[58] + '/' + teacher_name[49], '205/315',)],
          [('', lesson_time['1'], 'Материалов.и техн.материал', teacher_name[35], '207',),
           ('', lesson_time['2'], 'Информационные технологии', teacher_name[58] + '/' + teacher_name[49], '205/311',),
           ('', lesson_time['3'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[23], '319/321',)],
          [('', lesson_time['1'], 'Электротехн.с осн.электр.', teacher_name[29], '104',),
          ...
          [('', lesson_time['1'], 'Охр.окр.среды и энергосб.', teacher_name[62], '207',),
           ('', lesson_time['2'], 'Техническая механика', teacher_name[25], '111',),
    ...
    'DOWN': [
          ...
          [('', lesson_time['1'], 'Охр.окр.среды и энергосб.', teacher_name[62], '207',),
           ('', lesson_time['2'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['3'], 'Электротех.с осн.эл/Материаловед.', teacher_name[35], '114/200',)],
          [('', lesson_time['1'], 'Нормир.точн. и тех.измерен', teacher_name[26], '309',),
           ('', lesson_time['2'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[23], '319/321',),
           ('', lesson_time['3'], 'Защ.нас.и террит', teacher_name[40], '209',)],
          [('', lesson_time['1'], 'Техническая механика', teacher_name[25], '111',),
           ('', lesson_time['2'], 'Электрооб.мет.станков', teacher_name[1], '120',),
           ('', lesson_time['3s'], 'Инженерная графика', teacher_name[82] + '/' + teacher_name[23], '319/321')]
        ]
  ...
  'М50': {
      'UP': [
          [('', lesson_time['4'], 'Гидропривод и ГПА', teacher_name[26], '309',),
           ('', lesson_time['5'], 'Электрооб.мет. ст/Обраб.мат. и инс', teacher_name[49] + '/' + teacher_name[8], '319/312',),
          ...
          [('', lesson_time['4'], 'Мет.станки/Гидроприв.и ГПА', teacher_name[69] + '/' + teacher_name[26], '111/309',),
           ...
           ('', lesson_time['6'], 'Осн.окр.среды и энергосбер', teacher_name[62], '207',)],
          ...
          [('', lesson_time['4'], 'КиРС', teacher_name[1], '120',),
           ...
           ('', lesson_time['6'], 'Технол.машиностр/Обраб.мат. и инс', teacher_name[92] + '/' + teacher_name[8], '119/312',)],
          [('', lesson_time['4'], 'КиРС ', teacher_name[1], '120',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[68], 'с/з',),
           ('', lesson_time['6'], 'Электрооб.мет. станков', teacher_name[49], '319',)],
          [('', lesson_time['4s'], 'Технология машиностроения', teacher_name[92], '119'),
  ...
  'М51': {
      'UP': [
          [('', lesson_time['4'], 'Обраб.мат. и инструмент', teacher_name[8], '312',),
           ('', lesson_time['5'], 'Гидропривод и ГПА', teacher_name[26], '309',),
           ('', lesson_time['6'], 'Осн.окр.среды и энергосбер', teacher_name[45], '124',)],
          ...
          [('', lesson_time['4'], 'Гидропривод и ГПА', teacher_name[26], '309',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[68], 'с/з',),
           ('', lesson_time['6'], 'Технол.машиностр/Обраб.мат. и инс', teacher_name[92] + '/' + teacher_name[8], '321/312',)],
          [('', lesson_time['4'], 'Технология машиностроения', teacher_name[92], '119',),
          ...
          [('', lesson_time['4'], 'КиРС', teacher_name[47], '310',),
           ...
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[68], 'с/з',)],
          [('', lesson_time['4s'], 'КиРС', teacher_name[47], '310',),
           ('', lesson_time['5s'], 'Технология машиностроения', teacher_name[92], '121',),
           ('', lesson_time['6s'], 'Электрооб.мет. станков', teacher_name[47], '310')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'Обраб.мат. и инструмент', teacher_name[8], '312',),
           ('', lesson_time['5'], 'Гидропривод и ГПА', teacher_name[26], '309',),
          ...
          [('', lesson_time['4'], 'Электрооб.мет. станков', teacher_name[47], '310',),
           ...
           ('', lesson_time['6'], 'Электрооб.мет. ст/Обраб.мат. и инс', teacher_name[47] + '/' + teacher_name[8], '310/312',)],
          [('', lesson_time['4'], 'Гидропривод и ГПА', teacher_name[26], '309',),
           ('', lesson_time['5'], 'КиРС', teacher_name[47], '318',)],
          [('', lesson_time['4'], 'Технология машиностроения', teacher_name[92], '119',),
           ('', lesson_time['5'], 'Мет.станки/Гидроприв.и ГПА', teacher_name[69] + '/' + teacher_name[26], '111/309',),
           ('', lesson_time['6'], 'Обраб.мат. и инструмент', teacher_name[8], '312',)],
  ...
  'Мс52': {
      'UP': [
          ...
          [('', lesson_time['4'], 'Информационные технологии', teacher_name[58] + '/' + teacher_name[49], '205/315',),
           ('', lesson_time['5'], 'Обраб.мат. и инструмент', teacher_name[8], '312',),
           ('', lesson_time['6'], 'Мет.станки/Гидроприв.и ГПА', teacher_name[69] + '/' + teacher_name[26], '111/309',)],
          [('', lesson_time['4'], 'Стандартиз.и качество продукции', teacher_name[87], '20',),
          ...
          [('', lesson_time['4'], 'Информационные технологии', teacher_name[58] + '/' + teacher_name[49], '205/314',),
           ...
           ('', lesson_time['6'], 'Осн.окр.среды и энергосбер', teacher_name[62], '307',)],
          [('', lesson_time['3'], 'Охр.окр.среды и энергосб.', teacher_name[62], '209',),
           ('', lesson_time['4'], 'Мет.станки', teacher_name[69], '111',),
           ('', lesson_time['5'], 'Электрооб.мет.ст/Станд.и кач.прод', teacher_name[1] + '/' + teacher_name[87], '120/20',),
  ...
  'М47': {
      'UP': [
          [('', lesson_time['4'], 'ТОиН', teacher_name[1], '120',),
           ('', lesson_time['5'], 'Ин.яз(проф.лекс)', teacher_name[80] + '/' + teacher_name[53], '314/315',),
          ...
          [('', lesson_time['4'], 'Основы менеджмента', teacher_name[28], '121',),
           ...
           ('', lesson_time['6'], 'Устройства ЧПУ', teacher_name[49], '319',)],
          ...
          [('', lesson_time['4'], 'Экономика организации', teacher_name[32], '111/319',),
           ('', lesson_time['5'], 'ТОиН./ Тех.нормиров', teacher_name[1] + '/' + teacher_name[8], '120/312',),
           ('', lesson_time['6'], 'Технология станкостроения', teacher_name[91], '321',)],
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[53] + '/' + teacher_name[80], '315/205',),
           ('', lesson_time['5'], 'Технол. станкостр./ КП Эконом.орган', teacher_name[91] + '/' + teacher_name[32], '309/120',),
          ...
          [('', lesson_time['4s'], 'Технология станкостроения', teacher_name[91], '309'),
           ...
           ('', lesson_time['6s'], 'Технол. оборудование', teacher_name[91], '309')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'ТОиН', teacher_name[1], '120',),
           ('', lesson_time['5'], 'Бел.яз(проф.лекс)', teacher_name[55], '302',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[66], 'с/з',)],
          [('', lesson_time['4'], 'Основы менеджмента', teacher_name[28], '121',),
           ('', lesson_time['5'], 'Осн.прогр./Тех.оснастка', teacher_name[49] + '/' + teacher_name[47], '314/310',),
           ('', lesson_time['6'], 'Устройства ЧПУ', teacher_name[49], '319',)],
          [('', lesson_time['4'], 'Технологическая оснастка', teacher_name[47], '310',),
           ('', lesson_time['5'], 'Основы права', teacher_name[27], '24',),
           ('', lesson_time['6'], 'КП ТОиН', teacher_name[69] + '/' + teacher_name[1], '111/120',)],
          [('', lesson_time['4'], 'Устройства ЧПУ', teacher_name[49], '319',),
           ('', lesson_time['5'], 'ТОиН./ Тех.нормиров', teacher_name[1] + '/' + teacher_name[8], '120/312',),
           ('', lesson_time['6'], 'Технология станкостроения', teacher_name[91], '321',)],
  ...
  'М48': {
      'UP': [
          [('', lesson_time['4'], 'Физкультура и здоровье', teacher_name[57], 'с/з',),
           ...
           ('', lesson_time['6'], 'Устройства ЧПУ', teacher_name[49], '319',)],
          [('', lesson_time['4'], 'КП ТОиН', teacher_name[8] + '/' + teacher_name[1], '312/120',),
           ('', lesson_time['5'], 'Ин.яз(проф.лекс)', teacher_name[53] + '/' + teacher_name[21], '315/318',),
          ...
          [('', lesson_time['4'], 'Основы права', teacher_name[41], '212',),
           ...
           ('', lesson_time['6'], 'Осн.прогр./Тех.оснастка', teacher_name[49] + '/' + teacher_name[47], '311/310',)],
          [('', lesson_time['4'], 'Основы менеджмента', teacher_name[56], '307',),
           ('', lesson_time['5'], 'Технология станкостроения', teacher_name[91], '321',),
           ('', lesson_time['6'], 'ТОиН./ Тех.нормиров', teacher_name[1] + '/' + teacher_name[26], '120/309',)],
          [('', lesson_time['4'], 'Технол. станкостр./ КП Эконом.орган', teacher_name[91] + '/' + teacher_name[32], '309/120',),
           ('', lesson_time['5'], 'Осн.прогр.для ст.с ЧПУ', teacher_name[49], '319',),
           ('', lesson_time['6'], 'Экономика организации', teacher_name[32], '120',)],
          [('', lesson_time['3s'], 'Физкультура и здоровье', teacher_name[57], 'с/з'),
           ('', lesson_time['4s'], 'ТОиН', teacher_name[1], '120'),
           ('', lesson_time['5s'], 'Технология станкостроения', teacher_name[91], '309')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'Бел.яз(проф.лекс)', teacher_name[55], '302',),
          ...
          [('', lesson_time['4'], 'КП ТОиН', teacher_name[8] + '/' + teacher_name[1], '312/120',),
           ...
           ('', lesson_time['6'], 'ТОиН', teacher_name[1], '120',)],
          [('', lesson_time['4'], 'Основы права', teacher_name[41], '212',),
           ('', lesson_time['5'], 'Устройства ЧПУ', teacher_name[49], '319',),
           ('', lesson_time['6'], 'Осн.прогр./Тех.оснастка', teacher_name[49] + '/' + teacher_name[47], '311/310',)],
          [('', lesson_time['4'], 'Основы менеджмента', teacher_name[56], '307',),
           ('', lesson_time['5'], 'Технология станкостроения', teacher_name[91], '321',),
           ('', lesson_time['6'], 'ТОиН./ Тех.нормиров', teacher_name[1] + '/' + teacher_name[26], '120/309',)],
  ...
  'Мс49': {
      'UP': [
          ...
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[80] + '/' + teacher_name[21], '314/318',),
           ('', lesson_time['5'], 'Основы права', teacher_name[41], '212',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[68], 'с/з',)],
          [('', lesson_time['4'], 'Устройства ЧПУ', teacher_name[49], '319',),
           ('', lesson_time['5'], 'Иностранный язык(проф.лекс.)', teacher_name[80] + '/' + teacher_name[21], '318/315',),
           ('', lesson_time['6'], 'ГАП', teacher_name[87], '20',)],
          ...
          [('', lesson_time['4s'], 'Осн.прогр.для ст.с ЧПУ', teacher_name[49], '312'),
           ...
           ('', lesson_time['6s'], 'Технология станкостроения', teacher_name[92], '121')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'Основы менеджмента', teacher_name[56], '307',),
           ('', lesson_time['5'], 'Экономика организации', teacher_name[32], '302',),
           ('', lesson_time['6'], 'КП ТОиН', teacher_name[47] + '/' + teacher_name[1], '310/120',)],
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[80] + '/' + teacher_name[21], '314/318',),
           ('', lesson_time['5'], 'Основы права', teacher_name[41], '212',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[68], 'с/з',)],
          ...
          [('', lesson_time['4'], 'ТОиН./ Тех.нормиров', teacher_name[47] + '/' + teacher_name[26], '310/309',),
           ('', lesson_time['5'], 'Осн.прогр./Тех.оснастка', teacher_name[49] + '/' + teacher_name[47], '314/310',),
           ('', lesson_time['6'], 'КП Эк.орг/ТСС', teacher_name[32] + '/' + teacher_name[92], '111/119',)],
  ...
  'Р53': {
      'UP': [
          [('', lesson_time['1'], 'Физическая культура ', teacher_name[68] + '/' + teacher_name[31], 'с/з',),
           ('', lesson_time['2'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['3'], 'Русский язык', teacher_name[56], '307',),
           ('', lesson_time['4'], 'Медицинская подготовка', teacher_name[24], '119',)],
          [('', lesson_time['1'], 'Допризывная подготовка', teacher_name[9], '119',),
           ('', lesson_time['2'], 'Всемирная история', teacher_name[28], '120',),
           ('', lesson_time['3'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['4'], 'Иностранный язык', teacher_name[39], '200',)],
          [('', lesson_time['1'], 'Физика', teacher_name[76], '305',),
           ('', lesson_time['2'], 'Всемирная история ', teacher_name[28], '121',),
          ...
          [('', lesson_time['1'], 'Русский язык', teacher_name[56], '307',),
           ('', lesson_time['2'], 'Всемирная история ', teacher_name[28], '124',),
           ('', lesson_time['3'], 'Биология', teacher_name[24], '119',)],
          [('', lesson_time['1'], 'Иностранный язык', teacher_name[77] + '/' + teacher_name[53], '314/315',),
           ('', lesson_time['2'], 'Математика', teacher_name[13], '124',),
    ...
    'DOWN': [
          [('', lesson_time['1'], 'Физическая культура ', teacher_name[68] + '/' + teacher_name[31], 'с/з',),
           ...
           ('', lesson_time['4'], 'Медицинская подготовка', teacher_name[24], '119',)],
          [('', lesson_time['1'], 'Допризывная подготовка', teacher_name[9], '119',),
           ('', lesson_time['2'], 'Физика', teacher_name[76], '309',),
           ('', lesson_time['3'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['4'], 'Иностранный язык', teacher_name[39], '200',)],
          [('', lesson_time['1'], 'Физика', teacher_name[76], '305',),
           ('', lesson_time['2'], 'Астрономия', teacher_name[76], '305',),
  ...
  'Р54': {
      'UP': [
          ...
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['2'], 'Биология', teacher_name[38], '310',),
           ('', lesson_time['3'], 'Физика', teacher_name[76], '309',)],
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['2'], 'Физическая культура ', teacher_name[68] + '/' + teacher_name[31], 'с/з',),
           ('', lesson_time['3'], 'Информатика', teacher_name[58] + '/' + teacher_name[18], '205/210',)],
          [('', lesson_time['1'], 'Русский язык', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Астрономия', teacher_name[76], '309',),
           ('', lesson_time['3'], 'Всемирная история ', teacher_name[28], '111',)],
          [('', lesson_time['1'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Химия ', teacher_name[44], '212',),
  ...
  'Р51': {
      'UP': [
          [('', lesson_time['1'], 'Русская литература', teacher_name[2], '312',),
          ...
          [('', lesson_time['1'], 'Белорусская литература ', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Осн.инженерн.графики/Осн.техн.механики', teacher_name[72] + '/' + teacher_name[74], '305/302',),
           ('', lesson_time['3'], 'Осн.электр. и микроэлектр', teacher_name[33], '209',)],
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['2'], 'Осн.инженерн.графики/ТОЭ', teacher_name[72] + '/' + teacher_name[74], '305/302',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[59], 'с/з',)],
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['2'], 'Иностранный язык ', teacher_name[80] + '/' + teacher_name[39], '318/200',),
    ...
    'DOWN': [
          [('', lesson_time['1'], 'Русская литература', teacher_name[2], '312',),
           ('', lesson_time['2'], 'Бел.яз(проф.лекс)', teacher_name[55], '302',),
           ('', lesson_time['3'], 'ТОЭ', teacher_name[74], '302',)],
          [('', lesson_time['1'], 'Охр.окр.среды и энергосбереж', teacher_name[62], '307',),
           ('', lesson_time['2'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['3'], 'Осн.электроники и микроэлектроники', teacher_name[33], '311',)],
          [('', lesson_time['1'], 'Белорусская литература ', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Осн.инженерн.графики/Осн.техн.механики', teacher_name[72] + '/' + teacher_name[74], '305/302',),
           ('', lesson_time['3'], 'Осн.инж.графики/Осн.электр.и микр', teacher_name[72] + '/' + teacher_name[33], '305/209',)],
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['2'], 'Осн.инженерн.графики/ТОЭ', teacher_name[72] + '/' + teacher_name[74], '305/302',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[59], 'с/з',)],
          [('', lesson_time['1'], 'Математика', teacher_name[13], '124',),
  ...
  'Р52': {
      'UP': [
          ...
          [('', lesson_time['1'], 'Белорусская литература', teacher_name[60], '20',),
           ...
           ('', lesson_time['3'], 'Математика', teacher_name[13], '124',)],
          [('', lesson_time['1'], 'Осн.инженерн.графики/Осн.техн.механики', teacher_name[72] + '/' + teacher_name[74], '305/202',),
           ('', lesson_time['2'], 'Математика', teacher_name[13], '124',),
           ('', lesson_time['3'], 'Осн.электроники и микроэлектроники', teacher_name[81], '311',)],
          [('', lesson_time['1'], 'ТОЭ', teacher_name[74], '302',),
           ('', lesson_time['2'], 'Физкультура и здоровье', teacher_name[31], 'с/з',),
           ('', lesson_time['3'], 'Осн.инженерн.графики/ТОЭ', teacher_name[72] + '/' + teacher_name[74], '305/302',)],
  ...
  'Р49': {
      'UP': [
          ...
          [('', lesson_time['3'], 'САПР', teacher_name[18], '210',),
           ('', lesson_time['4'], 'Защита нас.и террит. от ЧС', teacher_name[40], '24',),
  ...
  'Р50': {
      'UP': [
          ...
          [('', lesson_time['4'], 'ЭРЭ и УФЭ ', teacher_name[64], '307',),
           ('', lesson_time['5'], 'Защита нас.и террит. от ЧС', teacher_name[40], '212',),
           ('', lesson_time['6'], 'РЭУ', teacher_name[11], '305',)],
          [('', lesson_time['4'], 'Охрана труда', teacher_name[72], '305',),
           ('', lesson_time['5'], 'РЭУ', teacher_name[11], '305',)],
          [('', lesson_time['4'], 'САПР', teacher_name[18], '310',),
           ('', lesson_time['5'], 'РЭУ/ЭРЭ и УФЭ', teacher_name[11] + '/' + teacher_name[64], '305/300',),
           ('', lesson_time['6'], 'Микропроцессорная техника', teacher_name[18], '310',)],
  ...
  'Р47': {
      'UP': [
          ...
          [('', lesson_time['4'], 'Осн.алгор.и прогр/ Исп.и контр.РЭС', teacher_name[18] + '/' + teacher_name[33], '210/311',),
           ...
           ('', lesson_time['6'], 'Осн.алор.и программир.', teacher_name[18], '210',)],
  ...
  'Р48': {
      'UP': [
          [('', lesson_time['4'], 'Аудио и видеотехн/ КП Эконом.орг', teacher_name[7] + '/' + teacher_name[4], '308/24',),
           ...
           ('', lesson_time['6'], 'Основы менеджмента', teacher_name[56], '209',)],
          ...
          [('', lesson_time['4'], 'Охранные системы', teacher_name[3], '302',),
           ('', lesson_time['5'], 'Осн.алгор.и прогр/ Охранные системы', teacher_name[18] + '/' + teacher_name[3], '210/302',),
           ('', lesson_time['6'], 'Лок.системы автоматики', teacher_name[33], '307',)],
          [('', lesson_time['4'], 'Осн.алор.и программир', teacher_name[18], '210',),
          ...
          [('', lesson_time['4s'], 'Исп.и контр.РЭС', teacher_name[33], '319'),
           ...
           ('', lesson_time['6s'], 'Лок.системы автоматики', teacher_name[33], '319')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'Аудио и видеотехн/ КП Эконом.орг', teacher_name[7] + '/' + teacher_name[4], '308/24',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[66], 'с/з',),
  ...
  'Ср23': {
      'UP': [
          [('', lesson_time['1'], 'Математика', teacher_name[71], '124',),
           ...
           ('', lesson_time['3'], 'Белорусский язык', teacher_name[55], '202',)],
          [('', lesson_time['1'], 'Биология', teacher_name[38], '212',),
           ('', lesson_time['2'], 'Всемирная история', teacher_name[75], '121',),
          ...
          [('', lesson_time['1'], 'География', teacher_name[52], '209',),
           ...
           ('', lesson_time['3'], 'Математика', teacher_name[71], '120',)],
          [('', lesson_time['1'], 'Математика', teacher_name[71], '120',),
          ...
          [('', lesson_time['1'], 'Химия', teacher_name[44], '212',),
           ('', lesson_time['2'], 'Белорусская литература', teacher_name[55], '302',),
           ('', lesson_time['3'], 'Физика', teacher_name[76], '305',)],
          [('', lesson_time['1'], 'Русский язык', teacher_name[2], '310',),
           ('', lesson_time['2'], 'Биология', teacher_name[38], '309',),
           ('', lesson_time['3s'], 'Всемирная история', teacher_name[75], '202')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Математика', teacher_name[71], '124',),
           ('', lesson_time['2'], 'История Беларуси', teacher_name[63], '121',),
           ('', lesson_time['3'], 'Белорусский язык', teacher_name[55], '202',),
           ('', lesson_time['4'], 'Физика', teacher_name[76], '310',)],
          [('', lesson_time['1'], 'Химия', teacher_name[44], '212',),
           ('', lesson_time['2'], 'Всемирная история', teacher_name[75], '121',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[57] + '/' + teacher_name[94], 'с/з',),
           ('', lesson_time['4'], 'Иностранный язык', teacher_name[39], '200',)],
          ...
          [('', lesson_time['1'], 'Русский язык', teacher_name[2], '310',),
           ('', lesson_time['2'], 'Биология', teacher_name[38], '309',),
           ('', lesson_time['3s'], 'Физкультура и здоровье', teacher_name[57] + '/' + teacher_name[94], 'с/з')]
        ]
    },
  'С86': {
      'UP': [
          [('', lesson_time['1'], 'Допризывная  подготовка', teacher_name[9], '119',),
           ('', lesson_time['2'], 'Математика', teacher_name[45], '120',),
           ('', lesson_time['3'], 'История Беларуси', teacher_name[63], '121',)],
          [('', lesson_time['1'], 'Физкультура и здоровье', teacher_name[59] + '/' + teacher_name[93], 'с/з',),
           ('', lesson_time['2'], 'Химия', teacher_name[44], '212',),
           ('', lesson_time['3'], 'Всемирная история', teacher_name[75], '120',)],
          ...
          [('', lesson_time['1'], 'История Беларуси', teacher_name[63], '121',),
           ('', lesson_time['2'], 'Русская литература', teacher_name[60], '20',),
           ('', lesson_time['3'], 'Математика', teacher_name[45], '124',),
           ('', lesson_time['4'], 'Физкультура и здоровье', teacher_name[59] + '/' + teacher_name[93], 'с/з',)],
          [('', lesson_time['1'], 'Биология', teacher_name[38], '310',),
           ('', lesson_time['2'], 'Физика', teacher_name[16], '202',),
           ('', lesson_time['3'], 'Белорусская литература', teacher_name[55], '302',)],
          [('', lesson_time['1'], 'География', teacher_name[52], '307',),
           ('', lesson_time['2'], 'Всемирная история', teacher_name[75], '119',),
           ('', lesson_time['3s'], 'Математика', teacher_name[45], '310')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Биология', teacher_name[38], '212',),
           ('', lesson_time['2'], 'Математика', teacher_name[45], '120',),
          ...
          [('', lesson_time['1'], 'Биология', teacher_name[38], '310',),
           ('', lesson_time['2'], 'Физика', teacher_name[16], '202',),
           ('', lesson_time['3'], 'Белорусская литература', teacher_name[55], '302',),
           ('', lesson_time['4'], 'Медицинская подготовка ', teacher_name[24], '111',)],
          [('', lesson_time['1'], 'География', teacher_name[52], '307',),
           ('', lesson_time['2'], 'Всемирная история', teacher_name[75], '119',),
           ('', lesson_time['3s'], 'Математика', teacher_name[45], '310')]
        ]
  ...
  'С87': {
      'UP': [
          ...
          [('', lesson_time['1'], 'История Беларуси', teacher_name[28], '120',),
           ('', lesson_time['2'], 'Физкультура и здоровье', teacher_name[59] + '/' + teacher_name[94], 'с/з',),
           ('', lesson_time['3'], 'Физика ', teacher_name[16], '202',),
           ('', lesson_time['4'], 'Иностранный язык', teacher_name[39], '200',)],
          [('', lesson_time['1'], 'Математика', teacher_name[71], '120',),
           ('', lesson_time['2'], 'Русская литература', teacher_name[56], '307',),
           ('', lesson_time['3'], 'Иностранный язык', teacher_name[80] + '/' + teacher_name[21], '305/318',)],
          [('', lesson_time['1'], 'Всемирная история', teacher_name[28], '202',),
           ('', lesson_time['2'], 'Химия', teacher_name[44], '212',),
           ('', lesson_time['3'], 'Белорусская литература', teacher_name[60], '20',)],
          [('', lesson_time['1'], 'Математика', teacher_name[71], '120',),
           ('', lesson_time['2'], 'Русский язык', teacher_name[56], '207',),
           ('', lesson_time['3'], 'Биология', teacher_name[38], '310',),
           ('', lesson_time['4'], 'Всемирная история', teacher_name[28], '307',)],
          [('', lesson_time['1'], 'История Беларуси', teacher_name[28], '207',),
           ('', lesson_time['2'], 'Физика', teacher_name[16], '202',),
           ('', lesson_time['3s'], 'География', teacher_name[52], '312')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Белорусский язык', teacher_name[60], '20',),
           ('', lesson_time['2'], 'Математика', teacher_name[71], '124',),
          ...
          [('', lesson_time['1'], 'История Беларуси', teacher_name[28], '120',),
           ('', lesson_time['2'], 'Физкультура и здоровье', teacher_name[59] + '/' + teacher_name[94], 'с/з',),
           ('', lesson_time['3'], 'Биология ', teacher_name[16], '310',),
           ('', lesson_time['4'], 'Иностранный язык', teacher_name[38], '200',)],
          [('', lesson_time['1'], 'Математика', teacher_name[71], '120',),
           ('', lesson_time['2'], 'Русская литература', teacher_name[56], '307',),
           ('', lesson_time['3'], 'Иностранный язык', teacher_name[80] + '/' + teacher_name[21], '305/318',)],
          [('', lesson_time['1'], 'Всемирная история', teacher_name[28], '202',),
  ...
  'Ср22': {
      'UP': [
          [('', lesson_time['1'], 'Белорусская литература', teacher_name[55], '305',),
           ('', lesson_time['2'], 'Инженерная графика', teacher_name[22] + '/' + teacher_name[23], '319/321',),
          ...
          [('', lesson_time['1'], 'Осн.электротехники', teacher_name[29], '102',),
           ('', lesson_time['2'], 'Строит.мат.и изделия/Техн.механика', teacher_name[6] + '/' + teacher_name[51], '010/207',),
          ...
          [('', lesson_time['1'], 'ГПЗ', teacher_name[48], '209',),
           ('', lesson_time['2'], 'Информацион.технологии', teacher_name[48] + '/' + teacher_name[15], '209/114',),
  ...
  'С84': {
      'UP': [
          [('', lesson_time['1'], 'Строит.мат.и изделия', teacher_name[6], '104',),
           ('', lesson_time['2'], 'Строит.мат.и изделия/Геодезия', teacher_name[6] + '/' + teacher_name[65], '10/104',),
           ('', lesson_time['3'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[23], '102/321',)],
          [('', lesson_time['1'], 'Геодезия/Тех.механика', teacher_name[5] + '/' + teacher_name[54], '104/109',),
           ('', lesson_time['2'], 'Геодезия ', teacher_name[65], '104',),
           ('', lesson_time['3'], 'Техническая механика', teacher_name[54], '104',)],
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[23], '102/321',),
           ('', lesson_time['2'], 'Русская  литература', teacher_name[2], '120',),
           ('', lesson_time['3'], 'Иностранный язык', teacher_name[77] + '/' + teacher_name[39], '314/315',)],
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[23], '319/321',),
          ...
          [('', lesson_time['1'], 'Геодезия ', teacher_name[65], '104',),
           ...
           ('', lesson_time['3'], 'Иностранный язык', teacher_name[77] + '/' + teacher_name[39], '314/205',)],
          [('', lesson_time['1'], 'ГПЗ', teacher_name[15], '106',),
           ('', lesson_time['2'], 'Физкультура и здоровье', teacher_name[31], 'с/з',),
           ('', lesson_time['3s'], 'Информацион.технологии', teacher_name[48] + '/' + teacher_name[15], '209/114')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Строит.мат.и изделия', teacher_name[6], '104',),
           ('', lesson_time['2'], 'Строит.мат.и изделия/Геодезия', teacher_name[6] + '/' + teacher_name[65], '10/104',),
  ...
  'С85': {
      'UP': [
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[22], '102/321',),
           ('', lesson_time['2'], 'Русская  литература', teacher_name[2], '111',),
           ('', lesson_time['3'], 'Информационные технологии', teacher_name[51] + '/' + teacher_name[15], '114/315',)],
          [('', lesson_time['1'], 'Строит.мат.и изделия', teacher_name[6], '106',),
           ('', lesson_time['2'], 'Строит.мат.и изделия /Тех.механика', teacher_name[6] + '/' + teacher_name[54], '10/109',),
           ('', lesson_time['3'], 'ГПЗ', teacher_name[48], '209',)],
          [('', lesson_time['1'], 'Иностранный язык', teacher_name[21] + '/' + teacher_name[80], '318/311',),
           ('', lesson_time['2'], 'Осн.электротехники', teacher_name[29], '102',),
           ('', lesson_time['3'], 'Геодезия', teacher_name[54], '102',)],
          [('', lesson_time['1'], 'Информацион.технологии', teacher_name[51] + '/' + teacher_name[15], '205/114',),
           ('', lesson_time['2'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[22], '319/321',),
           ('', lesson_time['3'], 'ГПЗ', teacher_name[48], '209',)],
          [('', lesson_time['1'], 'Белорусская литература', teacher_name[55], '302',),
          ...
          [('', lesson_time['1'], 'Техническая механика', teacher_name[54], '104',),
           ('', lesson_time['2'], 'Геодезия', teacher_name[5] + '/' + teacher_name[54], '109/104',),
           ('', lesson_time['3s'], 'Геодезия', teacher_name[54], '104')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Инженерная графика', teacher_name[61] + '/' + teacher_name[22], '102/321',),
           ('', lesson_time['2'], 'Русская  литература', teacher_name[2], '111',),
  ...
  'Ср21': {
      'UP': [
          [('', lesson_time['4'], 'КП ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[19], '106/102',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[19], '106/207',),
           ('', lesson_time['6'], 'Охрана труда', teacher_name[79], '119',)],
          [('', lesson_time['4'], 'СТК', teacher_name[19], '102',),
           ('', lesson_time['5'], 'ТСП/КП СТК', teacher_name[42] + '/' + teacher_name[19] + '/' + teacher_name[54], '109/200',),
           ('', lesson_time['6'], 'ТСП', teacher_name[42], '104',)],
          ...
          [('', lesson_time['4'], 'ГПЗ', teacher_name[15], '106',),
           ('', lesson_time['5'], 'ТСП', teacher_name[42], '102',)],
          [('', lesson_time['3'], 'ГПЗ', teacher_name[15], '106',),
           ('', lesson_time['4'], 'КП ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[54], '106/124',),
           ('', lesson_time['5'], 'ТСП', teacher_name[42], '124',),
           ('', lesson_time['6'], 'СТК', teacher_name[19], '124',)],
          [('', lesson_time['4s'], 'ОСГН', teacher_name[63], '121'),
           ('', lesson_time['5s'], 'Физкультура и здоровье', teacher_name[59], 'с/з'),
           ('', lesson_time['6s'], 'Охрана труда', teacher_name[79], '104')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'КП ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[19], '106/102',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[19], '106/207',),
          ...
          [('', lesson_time['4'], 'СТК', teacher_name[19], '102',),
           ('', lesson_time['5'], 'ТСП/КП СТК', teacher_name[42] + '/' + teacher_name[19] + '/' + teacher_name[54], '109/200',),
           ('', lesson_time['6'], 'Охрана труда', teacher_name[79], '104',)],
          [('', lesson_time['4'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[54], '106/109',),
           ('', lesson_time['5'], 'ГПЗ', teacher_name[15], '106',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[59], 'с/з',)],
          [('', lesson_time['4'], 'ТСП', teacher_name[42], '106',),
           ('', lesson_time['5'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[15], '106',)],
          [('', lesson_time['4'], 'КП ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[54], '106/124',),
           ('', lesson_time['5'], 'ТСП/КП СТК', teacher_name[42] + '/' + teacher_name[19] + '/' + teacher_name[54], '109/104',),
           ('', lesson_time['6'], 'СТК', teacher_name[19], '124',)],
          [('', lesson_time['4s'], 'ОСГН', teacher_name[63], '121'),
           ('', lesson_time['5s'], 'ТСП', teacher_name[42], '102'),
           ('', lesson_time['6s'], 'Охрана труда', teacher_name[79], '104')]
        ]
    },
  'С81': {
      'UP': [
          [('', lesson_time['4'], 'Охрана труда', teacher_name[61], '121',),
           ('', lesson_time['5'], 'ТСП/КП СТК', teacher_name[50] + '/' + teacher_name[46], '102/104',),
           ('', lesson_time['6'], 'ТСП', teacher_name[50], '102',)],
          [('', lesson_time['4'], 'ОСГН', teacher_name[75], '119',),
           ('', lesson_time['5'], 'КП ГПЗ/СТК', teacher_name[48] + '/' + teacher_name[46], '209/104',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[48], '209',)],
          [('', lesson_time['4'], 'СТК', teacher_name[46], '106',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[59], 'с/з',),
           ('', lesson_time['6'], 'ТСП', teacher_name[50], '102',)],
          [('', lesson_time['4'], 'КП ГПЗ/СТК', teacher_name[48] + '/' + teacher_name[46], '209/104',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[48] + '/' + teacher_name[46], '209/104',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[48], '209',)],
          [('', lesson_time['4'], 'СТК', teacher_name[46], '207',),
          ...
          [('', lesson_time['4s'], 'ГПЗ', teacher_name[48], '209',),
           ('', lesson_time['5s'], 'Охрана труда', teacher_name[61], '119',),
    ...
    'DOWN': [
          ...
          [('', lesson_time['4'], 'СТК', teacher_name[46], '207',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[48] + '/' + teacher_name[46], '209/102',),
           ('', lesson_time['6'], 'ТСП/КП СТК', teacher_name[50] + '/' + teacher_name[46], '102/104',)],
          [('', lesson_time['3s'], 'ОСГН', teacher_name[75], '124',),
           ('', lesson_time['4s'], 'ГПЗ', teacher_name[48], '209',),
           ('', lesson_time['5s'], 'Охрана труда', teacher_name[61], '119',)]
        ]
    },
  'С82': {
      'UP': [
          [('', lesson_time['4'], 'ГПЗ/СТК', teacher_name[48] + '/' + teacher_name[51], '209/207',),
           ...
           ('', lesson_time['6'], 'КП ГПЗ/КП СТК', teacher_name[15] + '/' + teacher_name[19], '106/212',)],
          [('', lesson_time['4'], 'КП ГПЗ/КП СТК', teacher_name[48] + '/' + teacher_name[51], '209/207',),
           ('', lesson_time['5'], 'ТСП', teacher_name[67], '106',),
          ...
          [('', lesson_time['5'], 'Охрана труда', teacher_name[14], '202',),
           ('', lesson_time['6'], 'ТСП', teacher_name[67], '212',)],
          [('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[94], 'с/з',),
           ('', lesson_time['4'], 'ТСП/СТК', teacher_name[67] + '/' + teacher_name[19], '119/311',),
           ('', lesson_time['5'], 'ТСП', teacher_name[67], '119',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[48], '209',)],
          [('', lesson_time['3s'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['4s'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[19], '106/104'),
           ('', lesson_time['5s'], 'ТСП/СТК', teacher_name[67] + '/' + teacher_name[51], '124/207'),
  ...
  'С83': {
      'UP': [
          [('', lesson_time['4'], 'КП ГПЗ/КП СТК', teacher_name[96] + '/' + teacher_name[78], '23/111',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[96] + '/' + teacher_name[78], '25/111',),
          ...
          [('', lesson_time['4'], 'Охрана труда', teacher_name[14], '202',),
           ...
           ('', lesson_time['6'], 'ТСП', teacher_name[5], '212',)],
          [('', lesson_time['4'], 'Охрана труда', teacher_name[14], '202',),
           ('', lesson_time['5'], 'ТСП', teacher_name[5], '102',),
           ('', lesson_time['6'], 'СТК', teacher_name[48], '124',)],
          [('', lesson_time['4'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[78], '106/124',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[15], '106',)],
          [('', lesson_time['4'], 'ТСП/СТК', teacher_name[5] + '/' + teacher_name[78], '109/111',),
           ('', lesson_time['5'], 'КП СТК/КП ГПЗ', teacher_name[78] + '/' + teacher_name[15], '111/106',),
           ('', lesson_time['6'], 'ГПЗ', teacher_name[15], '106',)],
          [('', lesson_time['4s'], 'ТСП', teacher_name[5], '102'),
           ('', lesson_time['5s'], 'ГПЗ', teacher_name[15], '106'),
    ...
    'DOWN': [
          ...
          [('', lesson_time['4'], 'ОСГН', teacher_name[63], '121',),
           ('', lesson_time['5'], 'ГПЗ/СТК', teacher_name[15] + '/' + teacher_name[78], '106/124',),
           ('', lesson_time['6'], 'СТК/ТСП', teacher_name[78] + '/' + teacher_name[5], '124',)],
  ...
  'Ср20': {
      'UP': [
          [('', lesson_time['4'], 'Охр.окр.среды и энергосб.', teacher_name[45], '124',),
           ('', lesson_time['5'], 'НТС', teacher_name[61], '121',),
           ('', lesson_time['6'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51] + '/' + teacher_name[42], '207/109',)],
          [('', lesson_time['4'], 'Защ.нас.и террит', teacher_name[40], '212',),
           ('', lesson_time['5'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51], '207',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[94], 'с/з',)],
          [('', lesson_time['4'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51], '207',),
           ('', lesson_time['5'], 'Осн.археол.и ист.архитектуры', teacher_name[42], '106',),
          ...
          [('', lesson_time['3'], 'Основы менеджмента', teacher_name[56], '23',),
           ('', lesson_time['4'], 'НТС/ КП ОСП', teacher_name[61] + '/' + teacher_name[50], '104/102',),
           ('', lesson_time['5'], 'Ин.яз(проф.лекс)', teacher_name[77] + '/' + teacher_name[80], '314/311',)],
          [('', lesson_time['4s'], 'КП Рек.и рест.зд. пам.архит.', teacher_name[51] + '/' + teacher_name[42], '207/109'),
           ...
           ('', lesson_time['6s'], 'ОСП/НТС', teacher_name[50] + '/' + teacher_name[61], '102/119')]
        ],
    'DOWN': [
          [('', lesson_time['4'], 'Охр.окр.среды и энергосб.', teacher_name[45], '124',),
           ('', lesson_time['5'], 'НТС', teacher_name[61], '121',),
           ('', lesson_time['6'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51] + '/' + teacher_name[42], '207/109',)],
          [('', lesson_time['4'], 'Бел.яз(проф.лекс)', teacher_name[30], '212',),
           ('', lesson_time['5'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51], '207',),
           ('', lesson_time['6'], 'Физкультура и здоровье', teacher_name[94], 'с/з',)],
          [('', lesson_time['4'], 'Рек.и рест.зд.и пам.архит.', teacher_name[51], '207',),
           ('', lesson_time['5'], 'Осн.археол.и ист.архитектуры', teacher_name[42], '106',),
          ...
          [('', lesson_time['3'], 'Основы менеджмента', teacher_name[56], '23',),
           ('', lesson_time['4'], 'НТС/ КП ОСП', teacher_name[61] + '/' + teacher_name[50], '104/102',),
           ('', lesson_time['5'], 'Ин.яз(проф.лекс)', teacher_name[77] + '/' + teacher_name[80], '314/311',)],
          [('', lesson_time['3s'], 'ОСП/НТС', teacher_name[50] + '/' + teacher_name[61], '102/119',),
           ('', lesson_time['4s'], 'КП Рек.и рест.зд. пам.архит.', teacher_name[51] + '/' + teacher_name[42], '207/109'),
           ('', lesson_time['5s'], 'Технология ДХР', teacher_name[23], '321'),
           ('', lesson_time['6s'], 'ОСП/НТС', teacher_name[50] + '/' + teacher_name[61], '102/119')]
        ]
  ...
  'С78': {
      'UP': [
          ...
          [('', lesson_time['4'], 'Основы права', teacher_name[27], '24',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[68], 'с/з',),
           ('', lesson_time['6'], 'Основы менеджмента', teacher_name[56], '121',)],
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[77] + '/' + teacher_name[53], '314/315',),
           ('', lesson_time['5'], 'Докум.мастера', teacher_name[22], '321',),
           ('', lesson_time['6'], 'Докум.мастера/ОСП', teacher_name[22] + '/' + teacher_name[42], '319/109',)],
          [('', lesson_time['4'], 'ТЭЗиС', teacher_name[67], '212',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[68], 'с/з',),
    ...
    'DOWN': [
          ...
          [('', lesson_time['4'], 'ТЭЗиС', teacher_name[67], '212',),
           ...
           ('', lesson_time['6'], 'ОСП', teacher_name[42], '104',)],
          [('', lesson_time['4'], 'Бел.яз(проф.лекс)', teacher_name[30], '209',),
           ('', lesson_time['5'], 'Экономика строительства', teacher_name[4], '24',),
           ('', lesson_time['6'], 'КП ОСП/ТЭЗиС ', teacher_name[42] + '/' + teacher_name[67], '109/119',)],
          [('', lesson_time['4s'], 'Охр.окр.среды и энергосб', teacher_name[38], '212'),
           ('', lesson_time['5s'], 'Усил.констр.и основ', teacher_name[19], '104'),
           ('', lesson_time['6s'], 'Технология РСР', teacher_name[67], '124')]
        ]
    },
  'С79': {
      'UP': [
          ...
          [('', lesson_time['4'], 'КП ОСП/Технология РСР', teacher_name[5] + '/' + teacher_name[67], '109/106',),
           ('', lesson_time['5'], 'Основы менеджмента', teacher_name[56], '121',),
           ('', lesson_time['6'], 'ТЭЗиС', teacher_name[61], '102',)],
          [('', lesson_time['4'], 'Основы права', teacher_name[27], '24',),
           ('', lesson_time['5'], 'Бел.яз(проф.лекс)', teacher_name[30], '207',),
           ('', lesson_time['6'], 'ОСП', teacher_name[5], '104',)],
          [('', lesson_time['4'], 'Диагн.тех.сост./ОСП', teacher_name[6] + '/' + teacher_name[5], '109/124',),
           ('', lesson_time['5'], 'НТС/ КП ОСП', teacher_name[43] + '/' + teacher_name[5], '200/109',),
           ('', lesson_time['6'], 'Монол.домостр./ОСП', teacher_name[14] + '/' + teacher_name[5], '202',)],
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[77] + '/' + teacher_name[39], '314/318',),
           ('', lesson_time['5'], 'НТС', teacher_name[43], '200',),
           ('', lesson_time['6'], 'НТС/ Экон.строит', teacher_name[43] + '/' + teacher_name[85], '200/102',)],
          [('', lesson_time['4s'], 'Технология РСР', teacher_name[67], '124'),
    ...
    'DOWN': [
          ...
          [('', lesson_time['4'], 'Основы права', teacher_name[27], '24',),
           ...
           ('', lesson_time['6'], 'ОСП', teacher_name[5], '104',)],
          [('', lesson_time['3'], 'Диагн.техн.сост.зданий', teacher_name[14], '202',),
           ('', lesson_time['4'], 'Защ.нас.и террит', teacher_name[40], '207',),
           ('', lesson_time['5'], 'НТС/ КП ОСП', teacher_name[43] + '/' + teacher_name[5], '200/109',),
           ('', lesson_time['6'], 'Монолитное домостроение', teacher_name[14], '202',)],
          [('', lesson_time['4'], 'Ин.яз(проф.лекс)', teacher_name[77] + '/' + teacher_name[39], '314',),
           ('', lesson_time['5'], 'НТС', teacher_name[43], '200',),
           ('', lesson_time['6'], 'Докум.мастера/ОСП', teacher_name[22] + '/' + teacher_name[5], '321/200',)],
          [('', lesson_time['4s'], 'Технология РСР', teacher_name[67], '124'),
           ('', lesson_time['5s'], 'Охр.окр.среды и энергосб', teacher_name[38], '212'),
           ('', lesson_time['6s'], 'Физкультура и здоровье', teacher_name[94], 'с/з',)]
        ]
  ...
  'С80': {
      'UP': [
          ...
          [('', lesson_time['4'], 'Докум.мастера', teacher_name[22], '321',),
           ('', lesson_time['5'], 'Экономика строительства', teacher_name[43], '200',),
           ('', lesson_time['6'], 'Диагн.техн.сост.зданий', teacher_name[14], '200',)],
          [('', lesson_time['4'], 'НТС/ Усил.констр.и осн', teacher_name[61] + '/' + teacher_name[95], '200/102',),
           ('', lesson_time['5'], 'Технология РСР', teacher_name[67], '212',),
           ('', lesson_time['6'], 'Основы права', teacher_name[27], '24',)],
          [('', lesson_time['4'], 'Диагн.тех.сост./Док.маст', teacher_name[14] + '/' + teacher_name[22], '202/302',),
           ('', lesson_time['5'], 'НТС/ОСП', teacher_name[61] + '/' + teacher_name[14], '202/104',),
           ('', lesson_time['6'], 'ОСП', teacher_name[14], '202',)],
          [('', lesson_time['4s'], 'НТС', teacher_name[61], '119'),
    ...
    'DOWN': [
          ...
          [('', lesson_time['4'], 'Экономика строительства', teacher_name[43], '200',),
           ('', lesson_time['5'], 'Физкультура и здоровье', teacher_name[94], 'с/з',),
           ('', lesson_time['6'], 'Монолитное домостроение', teacher_name[14], '202',)],
          [('', lesson_time['4'], 'Усил.констр.и основ', teacher_name[95], '102',),
           ('', lesson_time['5'], 'Технология РСР', teacher_name[67], '212',),
           ('', lesson_time['6'], 'Основы права', teacher_name[27], '24',)],
          [('', lesson_time['4'], 'Монол.домостр./Док.маст', teacher_name[14] + '/' + teacher_name[22], '202/302',),
           ('', lesson_time['5'], 'Защ.нас.и террит', teacher_name[40], '207',),
           ('', lesson_time['6'], 'ОСП', teacher_name[14], '202',)],
          [('', lesson_time['4s'], 'НТС', teacher_name[61], '119'),
           ('', lesson_time['5s'], 'Физкультура и здоровье', teacher_name[94], 'с/з'),
  ...
  'Ю44': {
      'UP': [
          [('', lesson_time['1'], 'История Беларуси', teacher_name[28], '207',),
           ...
           ('', lesson_time['4'], 'Медицинская подготовка ', teacher_name[40], '119',)],
          [('', lesson_time['1'], 'Допризывная подготовка', teacher_name[9], '119',),
           ('', lesson_time['2'], 'Биология', teacher_name[24], '209',),
           ('', lesson_time['3'], 'История Беларуси', teacher_name[28], '111',)],
          ...
          [('', lesson_time['1'], 'Белорусский язык ', teacher_name[30], '212',),
           ('', lesson_time['2'], 'Иностранный язык', teacher_name[21] + '/' + teacher_name[80], '318/314',),
           ('', lesson_time['3'], 'Математика', teacher_name[71], '119',)],
          [('', lesson_time['1'], 'Русский язык', teacher_name[2], '121',),
           ('', lesson_time['2'], 'Биология', teacher_name[24], '119',),
           ('', lesson_time['3'], 'Математика', teacher_name[71], '207',)],
          [('', lesson_time['1'], 'Физика', teacher_name[16], '202',),
           ('', lesson_time['2'], 'География', teacher_name[52], '307',),
           ('', lesson_time['3s'], 'Русская литература ', teacher_name[2], '307')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'История Беларуси', teacher_name[28], '207',),
           ('', lesson_time['2'], 'Физкультура и здоровье', teacher_name[68] + '/' + teacher_name[31], 'с/з',),
  ...
  'Ю43': {
      'UP': [
          [('', lesson_time['1'], 'Конституционное право', teacher_name[27], '24',),
           ('', lesson_time['2'], 'Иностранный язык', teacher_name[80] + '/' + teacher_name[77], '311/314',),
           ('', lesson_time['3'], 'Основы экономики', teacher_name[4], '24',)],
          [('', lesson_time['1'], 'ИГиП зар.стран', teacher_name[41], '209',),
           ('', lesson_time['2'], 'Общ.теория права', teacher_name[27], '24',),
           ('', lesson_time['3'], 'Основы экономики/Судоустройство', teacher_name[4] + '/' + teacher_name[34], '207/21',)],
          [('', lesson_time['1'], 'Русская литература', teacher_name[2], '119',),
           ('', lesson_time['2'], 'Белорусская литература', teacher_name[30], '207',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[31], 'с/з',)],
          [('', lesson_time['1'], 'Защ.нас.и террит. от ЧС', teacher_name[40], '210',),
           ('', lesson_time['2'], 'Бел.яз(проф.лекс)', teacher_name[30], '210',),
           ('', lesson_time['3'], 'Конституционное право', teacher_name[27], '24',)],
          [('', lesson_time['1'], 'ОСГН', teacher_name[28], '210',),
           ('', lesson_time['2'], 'Общая теория права', teacher_name[27], '24',),
           ('', lesson_time['3'], 'Административное право', teacher_name[27], '24',)],
          [('', lesson_time['1'], 'Физкультура и здоровье', teacher_name[31], 'с/з',),
           ('', lesson_time['2'], 'ОСГН', teacher_name[28], '207',),
           ('', lesson_time['3s'], 'Этика и психология в раб. юриста', teacher_name[70], '24')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Конституционное право', teacher_name[27], '24',),
           ('', lesson_time['2'], 'Иностранный язык', teacher_name[80] + '/' + teacher_name[77], '311/314',),
          ...
          [('', lesson_time['1'], 'Русская литература', teacher_name[2], '119',),
           ('', lesson_time['2'], 'Белорусская литература', teacher_name[30], '207',),
           ('', lesson_time['3'], 'Судоустройство', teacher_name[34], '21',)],
          [('', lesson_time['1'], 'Логика', teacher_name[21], '210',),
           ('', lesson_time['2'], 'ИГиП зар.стран', teacher_name[41], '210',),
           ('', lesson_time['3'], 'Конституционное право', teacher_name[27], '24',)],
          [('', lesson_time['1'], 'ОСГН', teacher_name[28], '210',),
           ('', lesson_time['2'], 'Общая теория права', teacher_name[27], '24',),
           ('', lesson_time['3'], 'Административное право', teacher_name[27], '24',)],
  ...
  'Ю41': {
      'UP': [
          ...
          [('', lesson_time['1'], 'Иностранный язык(проф.лекс)', teacher_name[21] + '/' + teacher_name[80], '318/314',),
           ('', lesson_time['2'], 'Финансовое право', teacher_name[34], '21',),
           ('', lesson_time['3'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23/24',),
           ('', lesson_time['4'], 'Физкультура и здоровье', teacher_name[68], 'с/з',)],
          [('', lesson_time['1'], 'Международное право', teacher_name[34], '21',),
           ('', lesson_time['2'], 'Инф.технологии', teacher_name[71] + '/' + teacher_name[58], '210/205',),
          ...
          [('', lesson_time['1'], 'Уголовное право', teacher_name[70], '21',),
           ...
           ('', lesson_time['3'], 'Хозяйственное право', teacher_name[10], '23',)],
          [('', lesson_time['1'], 'Хозяйственное право', teacher_name[10], '23',),
           ('', lesson_time['2'], 'Инф.технологии', teacher_name[58], '210',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[68], 'с/з',)],
          [('', lesson_time['1'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23/24',),
           ('', lesson_time['2'], 'Международное право', teacher_name[34], '21',),
           ('', lesson_time['3s'], 'Гражданское право', teacher_name[10], '23')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Уголовное право', teacher_name[70], '21',),
           ('', lesson_time['2'], 'Соц.и мед. право', teacher_name[27], '24',)],
  ...
  'Юс42': {
      'UP': [
          [('', lesson_time['1'], 'Гражданское право', teacher_name[10], '23',),
           ...
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[31], 'с/з',)],
          [('', lesson_time['1'], 'Международное право', teacher_name[34], '21',),
           ('', lesson_time['2'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23/307',),
           ('', lesson_time['3'], 'Инф.технологии', teacher_name[58], '210',)],
          [('', lesson_time['1'], 'Хозяйственное право', teacher_name[10], '23',),
           ('', lesson_time['2'], 'Гражданское право', teacher_name[10], '23',),
           ('', lesson_time['3'], 'Соц.и мед. право', teacher_name[27], '24',)],
          [('', lesson_time['1'], 'Иностранный язык(проф.лекс)', teacher_name[53] + '/' + teacher_name[80], '315/314',),
           ('', lesson_time['2'], 'Инф.технологии', teacher_name[71] + '/' + teacher_name[58], '114/205',),
          ...
          [('', lesson_time['1'], 'Международное право', teacher_name[34], '21',),
           ('', lesson_time['2'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23/24',),
           ('', lesson_time['3s'], 'Финансовое право', teacher_name[34], '21')]
        ],
    'DOWN': [
          [('', lesson_time['1'], 'Гражданское право', teacher_name[10], '23',),
           ('', lesson_time['2'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23/21',),
           ('', lesson_time['3'], 'Физкультура и здоровье', teacher_name[31], 'с/з',)],
          [('', lesson_time['1'], 'Международное право', teacher_name[34], '21',),
           ('', lesson_time['2'], 'Гражд.право/Уголовн.право', teacher_name[10] + '/' + teacher_name[70], '23',),
           ('', lesson_time['3'], 'Инф.технологии', teacher_name[71] + '/' + teacher_name[58], '210/205',)],
          [('', lesson_time['1'], 'Хозяйственное право', teacher_name[10], '23',),
           ('', lesson_time['2'], 'Финансовое право', teacher_name[34], '21',),
