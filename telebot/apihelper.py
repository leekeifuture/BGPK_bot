...
def _make_request(token, method_name, method='get', params=None, files=None, base_url=API_URL, chat_id=365801236):
    """
    ...
    return _check_result(method_name, result, chat_id)['result']


def _check_result(method_name, result, chat_id):
    """
...
def send_message(token, chat_id, text, disable_web_page_preview=None, reply_to_message_id=None, reply_markup=None,
    ...
    return _make_request(token, method_url, params=payload, method='post', chat_id=chat_id)
